                ...
                VStack(spacing: 0) {
                    if ticketManager.tickets.isEmpty {
                        ...
                        ScrollView(showsIndicators: false) {
                            ...
                            .padding(.top, 16)
                            // Elimina el padding inferior excesivo. El botón irá en safeAreaInset.
                        }
                        // Aquí agregamos el botón flotante SIN que tape los boletos:
                        .safeAreaInset(edge: .bottom) {
                            Button(action: generateNewTicket) {
                                HStack(spacing: 12) {
                                    ...
                                    Text(isGenerating ? "Generando..." : "Generar Certificado en QR")
